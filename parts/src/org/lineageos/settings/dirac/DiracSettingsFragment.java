...
public class DiracSettingsFragment extends PreferenceFragmentCompat implements
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        ListPreference headsetTypePref = findPreference(PREF_HEADSET);
        headsetTypePref.setOnPreferenceChangeListener(this);
        headsetTypePref.setEnabled(enhancerEnabled);

        ListPreference presetPref = findPreference(PREF_PRESET);
        presetPref.setOnPreferenceChangeListener(this);
        presetPref.setEnabled(enhancerEnabled);
    }
