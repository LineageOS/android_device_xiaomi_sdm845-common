...
Value* VerifyModemFn(const char* name, State* state,
    ...
    ret = get_version(current_modem_version, MODEM_VER_BUF_LEN,
            MODEM_PART_PATH, MODEM_VER_STR, MODEM_VER_STR_LEN);
    if (ret) {
...
Value* VerifyVendorFn(const char* name, State* state,
    ...
    ret = get_version(current_vendor_version, VENDOR_VER_BUF_LEN,
            VENDOR_PART_PATH, VENDOR_VER_STR, VENDOR_VER_STR_LEN);
    if (ret) {
        return ErrorAbort(state, kVendorFailure,
    ...
    ret = get_version(current_vndk_version, VNDK_VER_BUF_LEN,
            VENDOR_PART_PATH, VNDK_VER_STR, VNDK_VER_STR_LEN);
    if (ret) {
        return ErrorAbort(state, kVendorFailure,
