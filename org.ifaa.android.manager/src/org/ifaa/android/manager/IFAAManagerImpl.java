...
public class IFAAManagerImpl extends IFAAManagerV3 {
    ...
    public String getExtInfo(int authType, String keyExtInfo) {
        Slog.i(TAG, "getExtInfo:" + authType +
                WifiEnterpriseConfig.CA_CERT_ALIAS_DELIMITER + keyExtInfo);
    ...
    public int getSupportBIOTypes(Context context) {
        ...
        int supportBIOTypes = "none".equalsIgnoreCase(fpVendor) ?
                ifaaType & IFAA_TYPE_IRIS : ifaaType & (IFAA_TYPE_FINGER | IFAA_TYPE_IRIS);
