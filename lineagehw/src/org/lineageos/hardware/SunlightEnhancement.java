...
public class SunlightEnhancement {
    ...
    private static final String HBM_PATH =
            "/sys/devices/platform/soc/ae00000.qcom,mdss_mdp/drm/card0/card0-DSI-1/hbm_mode";
    ...
    private static boolean hasAmoledPanel() {
        return Build.DEVICE.equals("dipper") || Build.DEVICE.equals("ursa") ||
                Build.DEVICE.equals("equuleus") || Build.DEVICE.equals("perseus");
    }
