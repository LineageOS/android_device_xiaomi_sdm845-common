...
public class ProximitySensor implements SensorEventListener {
    ...
    private static final String FPC_PROX_NODE =
            "/sys/devices/platform/soc/soc:fingerprint_fpc/irq_enable";
    ...
    private void setFPProximityState(boolean isNear) {
        boolean nodeValue = mVendorName.equals("fpc") ? !isNear : isNear;
        try {
            FileUtils.stringToFile(mFPProximityNode, nodeValue ? "1" : "0");
        } catch (IOException e) {
